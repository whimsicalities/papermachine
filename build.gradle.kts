...
paperweight {
    serverProject.set(project(":papermachine-server"))
    ...
    usePaperUpstream(providers.gradleProperty("paperRef")) {
        withPaperPatcher {
            ...
            apiOutputDir.set(layout.projectDirectory.dir("papermachine-api"))

            serverPatchDir.set(layout.projectDirectory.dir("patches/server"))
            serverOutputDir.set(layout.projectDirectory.dir("papermachine-server"))
        }
    }
}
...
tasks.generateDevelopmentBundle {
    apiCoordinates.set("com.example.paperfork:papermachine-api")
